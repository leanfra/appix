...
func (x *CreateDatacentersReply) GetCode() int64 {
	if x != nil {
		return x.Code
	}
	return 0
...
func (x *UpdateDatacentersReply) GetCode() int64 {
	if x != nil {
		return x.Code
	}
	return 0
...
func (x *DeleteDatacentersRequest) GetIds() []int64 {
	if x != nil {
		return x.Ids
	}
	return nil
...
func (x *DeleteDatacentersReply) GetCode() int64 {
	if x != nil {
		return x.Code
	}
	return 0
...
func (x *GetDatacentersRequest) GetId() int64 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *GetDatacentersReply) GetCode() int64 {
	if x != nil {
		return x.Code
	}
	return 0
...
func (x *DatacenterFilter) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DatacenterFilter) ProtoMessage() {}

func (x *DatacenterFilter) ProtoReflect() protoreflect.Message {
	mi := &file_api_appix_v1_datacenters_proto_msgTypes[9]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DatacenterFilter.ProtoReflect.Descriptor instead.
func (*DatacenterFilter) Descriptor() ([]byte, []int) {
	return file_api_appix_v1_datacenters_proto_rawDescGZIP(), []int{9}
}

func (x *DatacenterFilter) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
type ListDatacentersFilter struct {
	...
	Filters  []*DatacenterFilter `protobuf:"bytes,3,rep,name=filters,proto3" json:"filters,omitempty"`
}

func (x *ListDatacentersFilter) Reset() {
	*x = ListDatacentersFilter{}
	mi := &file_api_appix_v1_datacenters_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ListDatacentersFilter) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ListDatacentersFilter) ProtoMessage() {}

func (x *ListDatacentersFilter) ProtoReflect() protoreflect.Message {
	mi := &file_api_appix_v1_datacenters_proto_msgTypes[10]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ListDatacentersFilter.ProtoReflect.Descriptor instead.
func (*ListDatacentersFilter) Descriptor() ([]byte, []int) {
	return file_api_appix_v1_datacenters_proto_rawDescGZIP(), []int{10}
}

func (x *ListDatacentersFilter) GetPage() int64 {
	if x != nil {
		return x.Page
	}
	return 0
...
func (x *ListDatacentersFilter) GetPageSize() int64 {
	if x != nil {
		return x.PageSize
	}
	return 0
...
func (x *ListDatacentersFilter) GetFilters() []*DatacenterFilter {
	if x != nil {
		return x.Filters
	}
	return nil
...
type ListDatacentersRequest struct {
	...
	Filter *ListDatacentersFilter `protobuf:"bytes,1,opt,name=filter,proto3" json:"filter,omitempty"`
}

func (x *ListDatacentersRequest) Reset() {
	*x = ListDatacentersRequest{}
	mi := &file_api_appix_v1_datacenters_proto_msgTypes[11]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ListDatacentersRequest) Descriptor() ([]byte, []int) {
	return file_api_appix_v1_datacenters_proto_rawDescGZIP(), []int{11}
}

func (x *ListDatacentersRequest) GetFilter() *ListDatacentersFilter {
	if x != nil {
		return x.Filter
	}
	return nil
...
func (x *ListDatacentersReply) Reset() {
	*x = ListDatacentersReply{}
	mi := &file_api_appix_v1_datacenters_proto_msgTypes[12]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ListDatacentersReply) Descriptor() ([]byte, []int) {
	return file_api_appix_v1_datacenters_proto_rawDescGZIP(), []int{12}
}
...
func (x *ListDatacentersReply) GetCode() int64 {
	if x != nil {
		return x.Code
	}
	return 0
...
var file_api_appix_v1_datacenters_proto_rawDesc = []byte{
	...
	0x69, 0x64, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x03, 0x52, 0x03, 0x69, 0x64, 0x73, 0x22, 0x5e,
	...
	0x01, 0x28, 0x03, 0x52, 0x02, 0x69, 0x64, 0x22, 0x95, 0x01, 0x0a, 0x13, 0x47, 0x65, 0x74, 0x44,
	...
	0x26, 0x0a, 0x10, 0x44, 0x61, 0x74, 0x61, 0x63, 0x65, 0x6e, 0x74, 0x65, 0x72, 0x46, 0x69, 0x6c,
	0x74, 0x65, 0x72, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x22, 0x82, 0x01, 0x0a, 0x15, 0x4c, 0x69, 0x73, 0x74,
	0x44, 0x61, 0x74, 0x61, 0x63, 0x65, 0x6e, 0x74, 0x65, 0x72, 0x73, 0x46, 0x69, 0x6c, 0x74, 0x65,
	...
	,
	...
	,
	...
	0x61, 0x70, 0x69, 0x2f, 0x76, 0x31, 0x2f, 0x64, 0x61, 0x74, 0x61, 0x63, 0x65, 0x6e, 0x74, 0x65,
	0x72, 0x73, 0x2f, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x12, 0x88, 0x01, 0x0a, 0x11, 0x55, 0x70,
	0x64, 0x61, 0x74, 0x65, 0x44, 0x61, 0x74, 0x61, 0x63, 0x65, 0x6e, 0x74, 0x65, 0x72, 0x73, 0x12,
	0x26, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x61, 0x70, 0x70, 0x69, 0x78, 0x2e, 0x76, 0x31, 0x2e, 0x55,
	0x70, 0x64, 0x61, 0x74, 0x65, 0x44, 0x61, 0x74, 0x61, 0x63, 0x65, 0x6e, 0x74, 0x65, 0x72, 0x73,
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x24, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x61, 0x70,
	0x70, 0x69, 0x78, 0x2e, 0x76, 0x31, 0x2e, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x44, 0x61, 0x74,
	...
	0x31, 0x2f, 0x64, 0x61, 0x74, 0x61, 0x63, 0x65, 0x6e, 0x74, 0x65, 0x72, 0x73, 0x2f, 0x75, 0x70,
	0x64, 0x61, 0x74, 0x65, 0x12, 0x88, 0x01, 0x0a, 0x11, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x44,
	...
	0x61, 0x63, 0x65, 0x6e, 0x74, 0x65, 0x72, 0x73, 0x2f, 0x64, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x12,
	0x7a, 0x0a, 0x0e, 0x47, 0x65, 0x74, 0x44, 0x61, 0x74, 0x61, 0x63, 0x65, 0x6e, 0x74, 0x65, 0x72,
	...
	0x69, 0x78, 0x2e, 0x76, 0x31, 0x2e, 0x47, 0x65, 0x74, 0x44, 0x61, 0x74, 0x61, 0x63, 0x65, 0x6e,
	0x74, 0x65, 0x72, 0x73, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x22, 0x20, 0x82, 0xd3, 0xe4, 0x93, 0x02,
	0x1a, 0x12, 0x18, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x76, 0x31, 0x2f, 0x64, 0x61, 0x74, 0x61, 0x63,
	0x65, 0x6e, 0x74, 0x65, 0x72, 0x73, 0x2f, 0x7b, 0x69, 0x64, 0x7d, 0x12, 0x80, 0x01, 0x0a, 0x0f,
	0x4c, 0x69, 0x73, 0x74, 0x44, 0x61, 0x74, 0x61, 0x63, 0x65, 0x6e, 0x74, 0x65, 0x72, 0x73, 0x12,
	...
	0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x22, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x61, 0x70, 0x70, 0x69,
	0x78, 0x2e, 0x76, 0x31, 0x2e, 0x4c, 0x69, 0x73, 0x74, 0x44, 0x61, 0x74, 0x61, 0x63, 0x65, 0x6e,
	0x74, 0x65, 0x72, 0x73, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x22, 0x23, 0x82, 0xd3, 0xe4, 0x93, 0x02,
	0x1d, 0x3a, 0x01, 0x2a, 0x22, 0x18, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x76, 0x31, 0x2f, 0x64, 0x61,
	0x74, 0x61, 0x63, 0x65, 0x6e, 0x74, 0x65, 0x72, 0x73, 0x2f, 0x6c, 0x69, 0x73, 0x74, 0x42, 0x27,
...
var file_api_appix_v1_datacenters_proto_msgTypes = make([]protoimpl.MessageInfo, 13)
var file_api_appix_v1_datacenters_proto_goTypes = []any{
	...
	(*DatacenterFilter)(nil),         // 9: api.appix.v1.DatacenterFilter
	(*ListDatacentersFilter)(nil),    // 10: api.appix.v1.ListDatacentersFilter
	(*ListDatacentersRequest)(nil),   // 11: api.appix.v1.ListDatacentersRequest
	(*ListDatacentersReply)(nil),     // 12: api.appix.v1.ListDatacentersReply
}
var file_api_appix_v1_datacenters_proto_depIdxs = []int32{
	...
	9,  // 3: api.appix.v1.ListDatacentersFilter.filters:type_name -> api.appix.v1.DatacenterFilter
	10, // 4: api.appix.v1.ListDatacentersRequest.filter:type_name -> api.appix.v1.ListDatacentersFilter
	0,  // 5: api.appix.v1.ListDatacentersReply.datacenters:type_name -> api.appix.v1.Datacenter
	1,  // 6: api.appix.v1.Datacenters.CreateDatacenters:input_type -> api.appix.v1.CreateDatacentersRequest
	3,  // 7: api.appix.v1.Datacenters.UpdateDatacenters:input_type -> api.appix.v1.UpdateDatacentersRequest
	5,  // 8: api.appix.v1.Datacenters.DeleteDatacenters:input_type -> api.appix.v1.DeleteDatacentersRequest
	7,  // 9: api.appix.v1.Datacenters.GetDatacenters:input_type -> api.appix.v1.GetDatacentersRequest
	11, // 10: api.appix.v1.Datacenters.ListDatacenters:input_type -> api.appix.v1.ListDatacentersRequest
	2,  // 11: api.appix.v1.Datacenters.CreateDatacenters:output_type -> api.appix.v1.CreateDatacentersReply
	4,  // 12: api.appix.v1.Datacenters.UpdateDatacenters:output_type -> api.appix.v1.UpdateDatacentersReply
	6,  // 13: api.appix.v1.Datacenters.DeleteDatacenters:output_type -> api.appix.v1.DeleteDatacentersReply
	8,  // 14: api.appix.v1.Datacenters.GetDatacenters:output_type -> api.appix.v1.GetDatacentersReply
	12, // 15: api.appix.v1.Datacenters.ListDatacenters:output_type -> api.appix.v1.ListDatacentersReply
