...
const (
	Clusters_CreateClusters_FullMethodName = "/api.appix.v1.Clusters/CreateClusters"
	Clusters_UpdateClusters_FullMethodName = "/api.appix.v1.Clusters/UpdateClusters"
	Clusters_DeleteClusters_FullMethodName = "/api.appix.v1.Clusters/DeleteClusters"
	Clusters_GetClusters_FullMethodName    = "/api.appix.v1.Clusters/GetClusters"
	Clusters_ListClusters_FullMethodName   = "/api.appix.v1.Clusters/ListClusters"
)
...
var Clusters_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.appix.v1.Clusters",
	...
	Metadata: "api/appix/v1/clusters.proto",
}
