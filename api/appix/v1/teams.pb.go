...
func (x *CreateTeamsReply) GetCode() int64 {
	if x != nil {
		return x.Code
	}
	return 0
...
func (x *UpdateTeamsReply) GetCode() int64 {
	if x != nil {
		return x.Code
	}
	return 0
...
func (x *DeleteTeamsRequest) GetIds() []int64 {
	if x != nil {
		return x.Ids
	}
	return nil
...
func (x *DeleteTeamsReply) GetCode() int64 {
	if x != nil {
		return x.Code
	}
	return 0
...
func (x *GetTeamsRequest) GetId() int64 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *GetTeamsReply) GetCode() int64 {
	if x != nil {
		return x.Code
	}
	return 0
...
func (x *TeamFilter) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *TeamFilter) GetCode() string {
	if x != nil {
		return x.Code
	}
	return ""
...
func (x *TeamFilter) GetLeader() string {
	if x != nil {
		return x.Leader
	}
	return ""
...
func (x *ListTeamsFilter) GetPage() int64 {
	if x != nil {
		return x.Page
	}
	return 0
...
func (x *ListTeamsFilter) GetPageSize() int64 {
	if x != nil {
		return x.PageSize
	}
	return 0
...
func (x *ListTeamsFilter) GetFilters() []*TeamFilter {
	if x != nil {
		return x.Filters
	}
	return nil
...
func (x *ListTeamsRequest) Reset() {
	*x = ListTeamsRequest{}
	mi := &file_api_appix_v1_teams_proto_msgTypes[11]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ListTeamsRequest) Descriptor() ([]byte, []int) {
	return file_api_appix_v1_teams_proto_rawDescGZIP(), []int{11}
}
...
func (x *ListTeamsReply) Reset() {
	*x = ListTeamsReply{}
	mi := &file_api_appix_v1_teams_proto_msgTypes[12]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ListTeamsReply) Descriptor() ([]byte, []int) {
	return file_api_appix_v1_teams_proto_rawDescGZIP(), []int{12}
}
...
func (x *ListTeamsReply) GetCode() int64 {
	if x != nil {
		return x.Code
	}
	return 0
...
var file_api_appix_v1_teams_proto_rawDesc = []byte{
	...
	0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x03, 0x52, 0x03, 0x69, 0x64, 0x73, 0x22, 0x58, 0x0a, 0x10,
	...
	0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x02, 0x69, 0x64, 0x22, 0x7d, 0x0a, 0x0d, 0x47, 0x65, 0x74,
	...
	0x61, 0x6d, 0x52, 0x04, 0x74, 0x65, 0x61, 0x6d, 0x22, 0x4c, 0x0a, 0x0a, 0x54, 0x65, 0x61, 0x6d,
	...
	0x6c, 0x65, 0x61, 0x64, 0x65, 0x72, 0x22, 0x76, 0x0a, 0x0f, 0x4c, 0x69, 0x73, 0x74, 0x54, 0x65,
	0x61, 0x6d, 0x73, 0x46, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x12, 0x12, 0x0a, 0x04, 0x70, 0x61, 0x67,
	...
	0x52, 0x08, 0x70, 0x61, 0x67, 0x65, 0x53, 0x69, 0x7a, 0x65, 0x12, 0x32, 0x0a, 0x07, 0x66, 0x69,
	0x6c, 0x74, 0x65, 0x72, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x18, 0x2e, 0x61, 0x70,
	0x69, 0x2e, 0x61, 0x70, 0x70, 0x69, 0x78, 0x2e, 0x76, 0x31, 0x2e, 0x54, 0x65, 0x61, 0x6d, 0x46,
	0x69, 0x6c, 0x74, 0x65, 0x72, 0x52, 0x07, 0x66, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x73, 0x22, 0x49,
	...
	0x28, 0x0b, 0x32, 0x1d, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x61, 0x70, 0x70, 0x69, 0x78, 0x2e, 0x76,
	0x31, 0x2e, 0x4c, 0x69, 0x73, 0x74, 0x54, 0x65, 0x61, 0x6d, 0x73, 0x46, 0x69, 0x6c, 0x74, 0x65,
	0x72, 0x52, 0x06, 0x66, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x22, 0x80, 0x01, 0x0a, 0x0e, 0x4c, 0x69,
	0x73, 0x74, 0x54, 0x65, 0x61, 0x6d, 0x73, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x12, 0x18, 0x0a, 0x07,
	...
	0x6f, 0x6e, 0x12, 0x28, 0x0a, 0x05, 0x74, 0x65, 0x61, 0x6d, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28,
	0x0b, 0x32, 0x12, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x61, 0x70, 0x70, 0x69, 0x78, 0x2e, 0x76, 0x31,
	0x2e, 0x54, 0x65, 0x61, 0x6d, 0x52, 0x05, 0x74, 0x65, 0x61, 0x6d, 0x73, 0x32, 0xab, 0x04, 0x0a,
	0x05, 0x54, 0x65, 0x61, 0x6d, 0x73, 0x12, 0x70, 0x0a, 0x0b, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65,
	...
	0x6d, 0x73, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x22, 0x1f, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x19, 0x3a,
	0x01, 0x2a, 0x22, 0x14, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x76, 0x31, 0x2f, 0x74, 0x65, 0x61, 0x6d,
	...
	0x70, 0x69, 0x78, 0x2e, 0x76, 0x31, 0x2e, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x54, 0x65, 0x61,
	...
	,
...
var file_api_appix_v1_teams_proto_msgTypes = make([]protoimpl.MessageInfo, 13)
var file_api_appix_v1_teams_proto_goTypes = []any{
	...
	(*TeamFilter)(nil),         // 9: api.appix.v1.TeamFilter
	(*ListTeamsFilter)(nil),    // 10: api.appix.v1.ListTeamsFilter
	(*ListTeamsRequest)(nil),   // 11: api.appix.v1.ListTeamsRequest
	(*ListTeamsReply)(nil),     // 12: api.appix.v1.ListTeamsReply
}
var file_api_appix_v1_teams_proto_depIdxs = []int32{
	...
	9,  // 3: api.appix.v1.ListTeamsFilter.filters:type_name -> api.appix.v1.TeamFilter
	10, // 4: api.appix.v1.ListTeamsRequest.filter:type_name -> api.appix.v1.ListTeamsFilter
	0,  // 5: api.appix.v1.ListTeamsReply.teams:type_name -> api.appix.v1.Team
	1,  // 6: api.appix.v1.Teams.CreateTeams:input_type -> api.appix.v1.CreateTeamsRequest
	3,  // 7: api.appix.v1.Teams.UpdateTeams:input_type -> api.appix.v1.UpdateTeamsRequest
	5,  // 8: api.appix.v1.Teams.DeleteTeams:input_type -> api.appix.v1.DeleteTeamsRequest
	7,  // 9: api.appix.v1.Teams.GetTeams:input_type -> api.appix.v1.GetTeamsRequest
	11, // 10: api.appix.v1.Teams.ListTeams:input_type -> api.appix.v1.ListTeamsRequest
	2,  // 11: api.appix.v1.Teams.CreateTeams:output_type -> api.appix.v1.CreateTeamsReply
	4,  // 12: api.appix.v1.Teams.UpdateTeams:output_type -> api.appix.v1.UpdateTeamsReply
	6,  // 13: api.appix.v1.Teams.DeleteTeams:output_type -> api.appix.v1.DeleteTeamsReply
	8,  // 14: api.appix.v1.Teams.GetTeams:output_type -> api.appix.v1.GetTeamsReply
	12, // 15: api.appix.v1.Teams.ListTeams:output_type -> api.appix.v1.ListTeamsReply
