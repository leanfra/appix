...
const (
	Tags_CreateTags_FullMethodName = "/api.opspillar.v1.Tags/CreateTags"
	Tags_UpdateTags_FullMethodName = "/api.opspillar.v1.Tags/UpdateTags"
	Tags_DeleteTags_FullMethodName = "/api.opspillar.v1.Tags/DeleteTags"
	Tags_GetTags_FullMethodName    = "/api.opspillar.v1.Tags/GetTags"
	Tags_ListTags_FullMethodName   = "/api.opspillar.v1.Tags/ListTags"
)
...
var Tags_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.opspillar.v1.Tags",
	...
	Metadata: "opspillar/v1/tags.proto",
}
