...
const (
	Applications_CreateApplications_FullMethodName = "/api.opspillar.v1.Applications/CreateApplications"
	Applications_UpdateApplications_FullMethodName = "/api.opspillar.v1.Applications/UpdateApplications"
	Applications_DeleteApplications_FullMethodName = "/api.opspillar.v1.Applications/DeleteApplications"
	Applications_GetApplications_FullMethodName    = "/api.opspillar.v1.Applications/GetApplications"
	Applications_ListApplications_FullMethodName   = "/api.opspillar.v1.Applications/ListApplications"
	Applications_MatchAppHostgroups_FullMethodName = "/api.opspillar.v1.Applications/MatchAppHostgroups"
)
...
var Applications_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.opspillar.v1.Applications",
