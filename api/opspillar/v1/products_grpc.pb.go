...
const (
	Products_CreateProducts_FullMethodName = "/api.opspillar.v1.Products/CreateProducts"
	Products_UpdateProducts_FullMethodName = "/api.opspillar.v1.Products/UpdateProducts"
	Products_DeleteProducts_FullMethodName = "/api.opspillar.v1.Products/DeleteProducts"
	Products_GetProducts_FullMethodName    = "/api.opspillar.v1.Products/GetProducts"
	Products_ListProducts_FullMethodName   = "/api.opspillar.v1.Products/ListProducts"
)
...
var Products_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.opspillar.v1.Products",
	...
	Metadata: "opspillar/v1/products.proto",
}
