...
func (m *MockHostgroupTagsRepo) CreateHostgroupTags(ctx context.Context, hgt []*repo.HostgroupTag) error {
	args := m.Called(ctx)
	return args.Error(0)
}

func (m *MockHostgroupTagsRepo) UpdateHostgroupTags(ctx context.Context, hgt []*repo.HostgroupTag) error {
	args := m.Called(ctx)
	return args.Error(0)
}
...
func (m *MockAppTagsRepo) CreateAppTags(ctx context.Context, a []*repo.AppTag) error {
	args := m.Called(ctx)
	return args.Error(0)
}

func (m *MockAppTagsRepo) UpdateAppTags(ctx context.Context, a []*repo.AppTag) error {
	args := m.Called(ctx)
	return args.Error(0)
}
