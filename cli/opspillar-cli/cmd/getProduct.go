...
Examples:
  opspillar get product                              # List all
  opspillar get product --names prod1,prod2          # Filter by names
  opspillar get product --codes code1,code2          # Filter by codes
  opspillar get product --ids 1,2,3                  # Filter by IDs
  opspillar get product --names prod1 --format yaml  # Custom format`,
