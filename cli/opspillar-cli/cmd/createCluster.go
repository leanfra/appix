...
Examples:
  opspillar create cluster --name cluster1 --desc "Production Cluster" --env prod --dc dc1
  opspillar create cluster --name cluster2 --desc "Development Cluster" --env dev --dc dc2`,
