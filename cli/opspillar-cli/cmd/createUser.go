...
Examples:
  opspillar create createUser --name john --email john@example.com
  opspillar create createUser --out-file user-template.yaml
  opspillar create createUser --yaml-file user.yaml`,
